...
struct TransferReadinessTests {
    ...
    /// Plant: in `OperationReadinessAssessment.init(_:hasDestinations:estimatedDuration:)`,
    ...
    @Test func startUsesTheSameRule() {
        ...
        let assessment = OperationReadinessAssessment(readiness, hasDestinations: true, estimatedDuration: nil)
