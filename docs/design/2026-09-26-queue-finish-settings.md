...
- Copied, not verified (Quick): amber banner (THESIS decision), no green anywhere, no checkmark, "SD_CARD_042 copied, not verified", "Only file sizes were compared on Shuttle A and Shuttle B. Do not erase the card." No Eject on this screen. Actions: [New Transfer], [Export Report]. ("Verify Now" is a good future feature; not in this pass.)
